...
- [x] **True OLED Theme:**
  - [x] Add pitch-black background token (`#000000`) for maximum power savings on OLED displays.
...
- [x] **SEC-0001 - Unprivileged Process Termination via Raw Shell Execution** `[Critical]`
  - **Location:** `osyster-app/app/src/main/java/dev/qtremors/osyster/ui/ProcessDashboard.kt`
...
- [x] **SEC-0002 - Deprecated Subscriber ID Query Triggering SecurityException on API 29+** `[High]`
  - **Location:** `osyster-app/app/src/main/java/dev/qtremors/osyster/monitor/NetworkMonitor.kt`
...
- [x] **SEC-0003 - Unrestricted Backup Configuration and Unspecified Cleartext Traffic Policy** `[Medium]`
  - **Location:** `osyster-app/app/src/main/AndroidManifest.xml`, `osyster-app/app/src/main/res/xml/backup_rules.xml`, `osyster-app/app/src/main/res/xml/data_extraction_rules.xml`
...
- [x] **ARCH-0001 - Missing Jetpack ViewModel Architecture Across Feature Screens** `[High]`
...
- [x] **ARCH-0002 - Tight Coupling of Leaf Composables to Context Singletons** `[Medium]`
...
- [x] **PERF-0001 - Static Memory Leak of Drawable App Icons in NetworkMonitor** `[High]`
...
- [x] **PERF-0002 - Main Thread Blocking I/O During Initial Screen Composition** `[High]`
...
- [x] **PERF-0003 - Synchronous Bitmap Drawing During Lazy List Recomposition** `[Medium]`
...
- [x] **PERF-0004 - Unbounded Polling Loops Ignoring Configured Diagnostics Interval** `[Medium]`
...
- [x] **REL-0001 - Fabricated Fallback Telemetry When SELinux Restricts Procfs Access** `[High]`
...
- [x] **REL-0002 - Missing Process UID Resolution Resulting in Unknown User Labels** `[Medium]`
...
- [x] **REL-0003 - Temperature Unit Preference Ignored Across Dashboards** `[Low]`
...
- [x] **REL-0004 - Show Kernel Threads Preference Has No Effect in SystemMonitor** `[Low]`
...
- [x] **UI-0001 - Hardcoded Bottom Spacers Causing Dock Overlap Across Varied Insets** `[Medium]`
...
- [x] **UI-0002 - Missing Pull-to-Refresh Gesture on Process and Network Dashboards** `[Low]`
...
- [x] **UI-0003 - Dark Theme Contrast Deficiencies on Surface Containers** `[Low]`
...
- [x] **A11Y-0001 - Interactive Touch Targets Below 48dp Minimum Threshold** `[High]`
...
- [x] **A11Y-0002 - Inaccessible Network Usage Canvas Chart for Screen Readers** `[Medium]`
...
- [x] **A11Y-0003 - Dock Navigation Items Missing Tab Semantics and Selected State** `[Medium]`
...
- [x] **I18N-0001 - Extensive Hardcoded User-Facing Strings in Dashboard Screens** `[Medium]`
...
- [x] **I18N-0002 - Hardcoded US Locale in Byte and Metric Formatters** `[Low]`
...
- [x] **BUILD-0001 - Unused Dependency `material-kolor` Packaged in Production Builds** `[Low]`
...
- [x] **BUILD-0002 - Dead Typography Tokens from Unrelated Project** `[Low]`
...
- [x] **BUILD-0003 - APK Output Naming Conflicts Between Build Variants** `[Low]`
...
- [x] **TEST-0001 - Missing Unit Test Suite for SystemMonitor Telemetry Parsers** `[Medium]`
...
- [x] **TEST-0002 - Unused Template Test Files in Test Suites** `[Low]`
